export declare type Mapper<T, K> = (element: T, indexOrKey: number | string, arrayOrObj?: List<T>) => K | Promise<K>;
export declare type Reducer<T, K> = (prev: K, curr: T, indexOrKey: number | string, arrayOrObj?: List<T>) => K | Promise<K>;
