    ...
    if (args.length) {
        if (hasPromises) {
            return (...innerArgs) => __awaiter(this, void 0, void 0, function* () {
                return Bluebird.reduce(args, (prev, curr, index) => __awaiter(this, void 0, void 0, function* () { return index === 0 ? curr.apply(curr, prev) : curr(prev); }), innerArgs);
            });
        }
        else {
            return (...innerArgs) => args.reduce((prev, curr, index) => index === 0 ? curr.apply(curr, prev) : curr(prev), innerArgs);
        }
    }
    else {
